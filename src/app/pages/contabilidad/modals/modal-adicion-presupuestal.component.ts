      ...
      <div class="modal-backdrop" data-testid="modal-adicion-presupuestal-backdrop" (click)="cerrarModal()">
        <div class="modal-box w-[540px]" data-testid="modal-adicion-presupuestal" (click)="$event.stopPropagation()">
          ...
          <div class="modal-body space-y-4 pt-3">
            ...
            <div class="grid grid-cols-2 gap-3">
              <div class="form-group flex flex-col items-start gap-1">
                ...
                <input
                  type="text"
                  class="input-base w-full text-xs font-semibold text-slate-800"
                  data-testid="input-adicion-numero-acuerdo"
                  [ngModel]="numeroAcuerdo()"
                  (ngModelChange)="numeroAcuerdo.set($event)"
                  placeholder="Ej. Acuerdo No. 04-CD"
                />
              </div>
              ...
              <div class="form-group flex flex-col items-start gap-1">
                ...
                <input
                  ...
                  data-testid="input-adicion-fecha-acuerdo"
            ...
            <!-- Justificación -->
            <div class="form-group flex flex-col items-start gap-1">
              <label class="form-label text-xs font-semibold text-gray-700">Justificación / Motivo del Mayor Ingreso</label>
              <textarea
                ...
                placeholder="Ej. Aprobado según Acuerdo No. 04 del Consejo Directivo del 15 de agosto por mayores aportes..."
              ></textarea>
            </div>
          </div>
...
export class ModalAdicionPresupuestalComponent {
  ...
  guardar(): void {
    ...
    const payload: any = {
      rubroCodigo: cod,
      montoAdicion: valor,
      numeroAcuerdo: this.numeroAcuerdo().trim() || undefined,
      fechaAcuerdo: this.fechaAcuerdo().trim() || undefined,
